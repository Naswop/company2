	...
	<script type="text/javascript">
	                                ...
	                                function (data) {
	                                    ...
	                                    setTimeout(function () {
	                                        ...
	                                        if (data.Status == 'ok') {
												...
												//跳转操作
													window.setTimeout("window.location='5.php'",2000); 
												　　
	                                        } else {
	                                            AjaxErro(data);
	                                        }
		...
		if(ajaxmockjax == 1){
			$.mockjax({  
				...
				status: 200,  
				responseTime: 50,          
				responseText: {"Status":"ok","Text":"<center>验证成功，正在跳转...</center>"}  
			}); 
			$.mockjax({  
				url: 'Ajax/LoginFalse',  
				status: 200,  
